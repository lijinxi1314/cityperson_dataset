...
# citypersons图像的标注位置
src_anno_dir = loadmat(r'F:\cityperson\annotations\anno_train.mat')

# cityscapes图像的存储位置
src_img_dir = r"F:\cityperson\leftImg8bit_trainvaltest\leftImg8bit\train\\"

#保存为VOC 数据集的原图和xml标注路径
new_img= r"F:\cityperson\cityscapes\JPEGImages"
new_xml=r"F:\cityperson\cityscapes\Annotations"
